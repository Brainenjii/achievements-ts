 ...
 *
 */
export const processTeamSolutions = (
  assignments: ICourseAssignmentsMap,
  members: ICourseMembersMap
): Promise<void> => {
 ...
 * @returns {*} value
 */
const getFrom = (source: object, field: string) => {
  return (source || {})[field] || {};
};
 ...
 */
export const getAssignmentsUIProps = (state: any) => ({
...
function getValueToSort(solutions: any, sortField: string) {
...
function checkVisibilitySolution(
  assignments: object,
  key: string,
  options: any
) {
